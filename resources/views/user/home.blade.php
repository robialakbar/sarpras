            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-4">
                    <div class="card border-left-dark shadow h-100 py-2 bg-success">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <a href="{{ action('LaporanController@laporan_barang', 'baik') }}">
                ...
                <div class="col-md-2 mb-4">
                    <div class="card border-left-dark shadow h-100 py-2 bg-warning">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <a href="{{ action('LaporanController@laporan_barang', 'ringan') }}">
                ...
                <div class="col-md-2 mb-4">
                    <div class="card border-left-dark shadow h-100 py-2 bg-danger">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <a href="{{ action('LaporanController@laporan_barang', 'berat') }}">
